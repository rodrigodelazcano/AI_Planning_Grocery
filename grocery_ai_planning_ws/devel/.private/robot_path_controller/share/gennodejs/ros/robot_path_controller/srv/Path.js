...
// (in-package robot_path_controller.srv)
...
class PathRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += 16 * object.waypoints.length;
    return length + 4;
  }
...
module.exports = {
  ...
  md5sum() { return '4a214603f798dc39b94ac5b447e437b3'; },
  datatype() { return 'robot_path_controller/Path'; }
};
